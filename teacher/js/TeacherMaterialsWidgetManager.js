...
var TeacherMaterialsWidgetManager = function(){
    var self = this;
    this.materials = [];
    this.filteredMaterials = [];
    this.selectedMaterial = undefined;
    this.selectCallback = undefined;
    this.listId = 'widgetMaterialsList';
    this.searchInputId = 'widgetSearch';
    ...
    this.onMaterialSelected = function(m){
        console.log(m);
    }
    ...
    this.initMaterialItem = function(){
        ...
        //    if (self.onMaterialSelected == undefined){
        //        return;
        //    }
        //    var id = $(this).attr('data-id');
        //    var m = self.getMaterialById(id);
        //    self.onMaterialSelected(m);
        //});
    ...
    this.initSearch = function(){
        $('#' + self.searchInputId).bind('keyup',function(){
            var text = $(this).val();
            console.log(text);
