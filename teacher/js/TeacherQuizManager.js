...
var TeacherQuizManager = function(){
    var self = this;
    this.cards = [];
    ...
    this.materialSearchWidget = new MaterialSearchWidget();
        ...
        self.currentUserManager.init(function(){
            self.loadCurrentExercise(function(){
                ...
                self.loadCards(function(){
                    ...
                    self.initSearchWidget(function(){
    ...
    this.initSearchWidget = function(callback){
        self.materialSearchWidget.selectCallback = function(m){
            $('#vimeoId').val(m.get('vimeoId'));
            $('#transcript').val( (m.get('transcript') == undefined) ? '' : m.get('transcript')  );
            $('#comment').val( (m.get('comment') == undefined) ? '' : m.get('comment')  );
        }
        self.materialSearchWidget.init(function(){
            callback();
        });
    }
    ...
    this.prepareSelectedCard = function(){
        ...
        //if (self.selectedCard.get('comment'))
    ...
    this.initUpdateBlock = function(){
        $('#updateButton').bind('click', function(){
            ...
            var comment = $('#updateComment').val().trim();
            var transcript = $('#updateTranscript').val().trim();
            var time = $('#time').val().trim();
