...
var AuditorApp = React.createClass({displayName: "AuditorApp",
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {style: this.componentStyle.placeholder}, 
                React.createElement(PatientRecordComponent, null)
            )
        );
    }
...
React.render(
    React.createElement(AuditorApp, null),
    document.getElementById('main')
);

},{"../components/buttons/RecordStopButton":160,"../components/record/PatientRecordComponent":161,"react":157}],160:[function(require,module,exports){
/**
 * Created by sabir on 17.09.15.
 */
var React = require('react');
...
},{"object-assign":2,"react":157}],161:[function(require,module,exports){
/**
 * Created by sabir on 17.09.15.
 */
var React = require('react');
...
var PatientRecordComponent = React.createClass({displayName: "PatientRecordComponent",
    ...
    initWebRTC: function(callback){
        ...
        getUserMedia.call(navigator, {audio: true, video: false},function(stream){
            ...
            this.recordRTC = RecordRTC(this.mediaStream);
            this.props.onInit();
            this.setState({
                initializing: false
            });
...
},{"../../mixins/FileUploadMixin":162,"../buttons/RecordStopButton":160,"object-assign":2,"react":157,"recordrtc":158}],162:[function(require,module,exports){
/**
