...
var StudentAuditorExercisesManager = function(){
    var self = this;
    ...
    this.getExercisePanelHtml = function(exercise){
        ...
        + '<div class="thumb">' +
        '<a href="auditorExercise.html?id=' + exercise.id + '" >'
        ...
        + '<p class="mb0">'
        + '<h4 class="mt0 mb0"><a href="auditorExercise.html?id='+ exercise.id +'">' + exercise.get('name') + ' </a></h4>'
        + '' +
        '   </p>'
