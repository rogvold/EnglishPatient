 ...
 */
var VimeoUploaderHelper = function(options) {
    var noop = function() {};
    ...
    this.token = Constants.VIMEO_UPLOAD_KEY;
 ...
 */
VimeoUploaderHelper.prototype.upload = function() {
    var self = this;
 ...
 * @private
 */
VimeoUploaderHelper.prototype.sendFile_ = function() {
 ...
 * @private
 */
VimeoUploaderHelper.prototype.resume_ = function() {
    var xhr = new XMLHttpRequest();
    xhr.open('PUT', this.url, true);
 ...
 */
VimeoUploaderHelper.prototype.extractRange_ = function(xhr) {
 ...
 * @private
 */
VimeoUploaderHelper.prototype.complete_ = function() {
 ...
 */
VimeoUploaderHelper.prototype.onContentUploadSuccess_ = function(e) {
 ...
 * @param {object} e XHR event
 */
VimeoUploaderHelper.prototype.onContentUploadError_ = function(e) {
 ...
 * @param {object} e XHR event
 */
VimeoUploaderHelper.prototype.onCompleteError_ = function(e) {
 ...
 * @param {object} e XHR event
 */
VimeoUploaderHelper.prototype.onUploadError_ = function(e) {
    this.onError(e.target.response); // TODO - Retries for initial upload
};
 ...
 */
VimeoUploaderHelper.prototype.buildQuery_ = function(params) {
    params = params || {};
 ...
 * @return {string} URL
 */
VimeoUploaderHelper.prototype.buildUrl_ = function(id, params, baseUrl) {
...
module.exports = VimeoUploaderHelper;